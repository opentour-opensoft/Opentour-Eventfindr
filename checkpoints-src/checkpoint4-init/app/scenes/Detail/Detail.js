...
class Detail extends React.Component {
    ...
    componentWillMount(){
        /*
         * #TODO 1: Invocar API do Weventual
         */
        var url = 'https://app.weventual.com/';
        this.setState({
            event: {},
            fotoUrl: url
        });
        ...
        return (
            <Image style={styles.container}  source={require('./../../assets/bg2.jpg')}>
                ...
                <View style={styles.infoContainer}>
                    { /* #TODO 2: Passar evento ao componente que apresenta a informação do evento*/}
                    <EventInfoContainer event={{}}/>
                </View>

                <View style={styles.footerContainer}>
                    { /* #TODO EXERCICIO: Usar a propriedade shareMessage do objeto event para apresentar a mensagem do evento */}
